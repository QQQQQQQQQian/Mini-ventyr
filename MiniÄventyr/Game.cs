...
namespace MiniÄventyr
{
    public class Game
    {
        ...
        public void Start()
        {
            ...
            Console.WriteLine($"Welcome {this.player.Name} the {this.player.Role}!");
        ...
        private void Adventure(Player player, Enemy[] enemies, Random rand)
        {
        ...
        private Enemy GetRandomEnemy(Enemy[] enemies, Random rand)
        {
